...
def upgrade() -> None:
    ...
    op.create_table('submission_states',
    sa.Column('state', sa.Enum('UPLOADING', 'UPLOADED', 'DOWNLOADING', 'DOWNLOADED', 'DECRYPTING', 'DECRYPTED', 'VALIDATING', 'VALIDATED', 'ENCRYPTING', 'ENCRYPTED', 'ARCHIVING', 'ARCHIVED', 'REPORTED', 'QCING', 'QCED', 'CLEANING', 'CLEANED', 'FINISHED', 'ERROR', name='submissionstateenum'), nullable=False),
